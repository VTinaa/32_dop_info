...

{
    ...
    // Змінюємо радіус кола через set-властивість
    circle.radius = 7;
...

{
    ...
    //     // Метод для додавання CSS-класу до колекції стилів
    //     addCssClass(cssClass) {
    //         this.styles.push(cssClass);
    //     }

    //     // Метод для встановлення кореневого елементу
    //     setRootElement(rootElement) {
    //         this.rootElement = rootElement;
    //     }

    //     // Метод для отримання HTML-коду зі стилями та кореневим елементом
    //     getCode() {
    //         let cssCode = "";
    ...
    // // Додавання CSS-класів до блоку
    // block.addCssClass(headingClass);
    // block.addCssClass(paragraphClass);

    // // Створення кореневого HTML-елементу
    // const rootElement = new HtmlElement("div", false);
    // rootElement.addClass("container");

    // // Додавання вмісту до кореневого елементу
    // const heading = new HtmlElement("h1", false, "Заголовок сторінки");
    ...
    // // Встановлення кореневого елементу для блоку
...
// ТЕМА: Об’єкт.Масиви.Об’єкт Array.Рядки.Об’єкт String.
//     Об’єкт Date.Об’єкт Math.Вступ до ООП:
// Завдання 4
// Реалізуйте клас, що описує блок HTML-документ.
// Клас HtmlBlock має містити:
// ■ колекцію стилів, описаних за допомогою класу CssClass;
